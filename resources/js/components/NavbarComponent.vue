	...
	<nav>
		<v-toolbar flat app>
			...
			<v-toolbar-title class="text-uppercase grey--text">
					<span class="font-weight-light">Techserve</span>
				<span>Admin</span>
			</v-toolbar-title>
		...
		<v-navigation-drawer :mini-variant.sync="mini" v-model="drawer" app stateless>
			...
			<v-list class="pt-0" dense>
				...
				<v-list-tile v-for="item in admin" :key="item.title" router-link :to="item.route">
					<v-list-tile-action>
        ...
        return {
            ...
            admin: [
                { title: 'Dashboard', icon: 'dashboard', route: '/home' },
									...
									{ title: 'Jobs', icon: 'assignment', route: '/jobs' },
	{ title: 'Bills', icon: 'receipt', route: '/work' },

								{ title: 'Attendance', icon: 'date_range', route: '/attendance' },
								{ title: 'Leave', icon: 'accessibility_new', route: '/leave' },
								{ title: 'expense', icon: 'money_off', route: '/expense' },
								{ title: 'vendor', icon: 'storefront', route: '/vendor' },
