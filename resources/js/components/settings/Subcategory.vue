<template>
  <div v-if="$can('admin-settings')">
    <div class="users">
      ...
      <v-container>
            <h1 class="subheading grey--text text-uppercase">Accessories</h1>
      </v-container>
        <v-container>
            ...
            <v-snackbar v-model="snackbar" color="success" bottom right>
                <span>Accessories deleted successfully.</span>
...
<script>
    ...
    import CreateAccessories from './dialogs/CreateSubcategory'
    import EditUser from './dialogs/EditAccessories'
    import DeleteUser from './dialogs/DeleteAccessories'

    export default {
        name: 'sub-category',
        components: {
            'dialog-create-user': CreateAccessories,
