<template>
  <div v-if="$can('admin-settings')">
    <div class="users">
      ...
      <v-container>
            <h1 class="subheading grey--text text-uppercase">Expense Type</h1>
      </v-container>
        <v-container>
            ...
            <v-snackbar v-model="snackbar" color="success" bottom right>
                <span>Expense Type deleted successfully.</span>
...
<script>
    ...
    import CreateUser from './dialogs/CreateExpenseType'
    import EditUser from './dialogs/EditExpenseType'
    import DeleteUser from './dialogs/DeleteExpenseType'
