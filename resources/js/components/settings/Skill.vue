...
<div v-if="$can('admin-settings')">
    <div class="users">
      ...
      <v-container>
            <h1 class="subheading grey--text text-uppercase">Skill</h1>
      </v-container>
        <v-container>
...
<script>
    ...
    import CreateUser from './dialogs/CreateSkill'
    import EditUser from './dialogs/EditSkill'
    import DeleteUser from './dialogs/DeleteSkill'
