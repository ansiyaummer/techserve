<template>
  <div v-if="$can('admin-settings')">
    <div class="users">
      ...
      <v-container>
            <h1 class="subheading grey--text text-uppercase">Tools</h1>
      </v-container>
        <v-container>
            ...
            <v-snackbar v-model="snackbar" color="success" bottom right>
                <span>Tools deleted successfully.</span>
...
<script>
    ...
    import CreateUser from './dialogs/CreateTools'
    import EditUser from './dialogs/EditTools'
    import DeleteUser from './dialogs/DeleteTools'
